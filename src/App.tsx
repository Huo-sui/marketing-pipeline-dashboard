...
const resources = [
  ...
  { name: "source-posts", list: "/source-posts", meta: { label: "爆帖分析" } },
  { name: "ideas", list: "/ideas", meta: { label: "选题箱" } },
  { name: "generation", list: "/generation", meta: { label: "待审草稿" } },
  { name: "release", list: "/release", meta: { label: "发布队列" } },
